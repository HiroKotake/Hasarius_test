        ...
        $params = [
            ...
            [
                ...
                "lines" => [
                    ...
                    "        Hasariusについて<br>",
                    "        Hasariusは文書にHTML作成に必要な情報を付け足すことによりHTMLを生成するツールです。<br>",
                    "        基本的にHTMLの属性を使用可能ですので、HTMLを作成したことのある方でしたHasariusの文法を知ることで、より簡単にHTML文書を生成することができるようになります。<br>",
                    "        また、HasariusはHTMLファイいるでは出来ないような文書を含んだ複数のテキストファイルを一つにまとめてHTMLファイルを生成するといた分散作成、定数定義といったことも可能です。<br>",
                    "    </body>",
                    "</html>",
                ]
            ],
    ...
    public function provideMake()
    {
        $params = [
            ...
            [
                ...
                "compareFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "compareFiles" . DIRECTORY_SEPARATOR . "test_000" . DIRECTORY_SEPARATOR . "html4_loose_html.html",
            ],
            // 平文 (head)
            [
                "DocumentType" => "HTML4_LOOSE",
                ...
                "source" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "test_000.txt",
                "saveFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "temp.html",
                "compareFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "compareFiles" . DIRECTORY_SEPARATOR . "test_000" . DIRECTORY_SEPARATOR . "html4_loose_head.html",
            ],
            // 平文 (html) + 変数あり
            [
                "DocumentType" => "XHTML1_1",
                ...
                "source" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "test_001.txt",
                "saveFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "temp.html",
                "compareFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "compareFiles" . DIRECTORY_SEPARATOR . "test_001" . DIRECTORY_SEPARATOR . "xhtml1_1_html.html",
            ],
            // 平文 (head) + 変数あり
            [
                "DocumentType" => "XHTML1_1",
                ...
                "source" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "test_001.txt",
                "saveFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "temp.html",
                "compareFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "compareFiles" . DIRECTORY_SEPARATOR . "test_001" . DIRECTORY_SEPARATOR . "xhtml1_1_head.html",
            ],
            // @include (html)
            [
                "DocumentType" => "HTML5",
                ...
                "source" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "test_002.txt",
                "saveFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "temp.html",
                "compareFile" => HASARIUS_TEST_DIR . DIRECTORY_SEPARATOR . "testdocs" . DIRECTORY_SEPARATOR . "compareFiles" . DIRECTORY_SEPARATOR . "test_002" . DIRECTORY_SEPARATOR . "html5_html.html",
            ],
            [
                "DocumentType" => "HTML5",
                "BasePosition" => "head",
