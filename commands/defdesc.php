...
class TestCommandDefdesc extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#defdesc style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#defdesc title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateXhtml1Loose()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#defdesc class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => '',
