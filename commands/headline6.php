...
class TestCommandHeadline6 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline6 class="サンプル テキスト"',
                "params" => [
                    "class" => 'サンプル テキスト',
                ],
                "result" => [],
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline6 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline6 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => [],
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline6 title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Strict()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_STRICT",
                "text" => '#headline6 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml11()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_1",
                "text" => '#headline6 class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
