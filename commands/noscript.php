...
class TestCommandNoscript extends HasariusTest
{
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#noscript style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Frame()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#noscript class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#noscript title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => [],
