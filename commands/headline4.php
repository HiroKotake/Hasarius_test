...
class TestCommandHeadline4 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline4 align="right"',
                "params" => [
                    "align" => 'right',    // SIDE_LMRJ
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline4 align="justfy"',
                "params" => [
                    "align" => 'justfy',    // SIDE_LMRJ
                ],
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline4 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline4 class="サンプル テキスト"',
                "params" => [
                    "class" => 'サンプル テキスト',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline4 align="middle"',
                "params" => [
                    "align" => 'middle',    // SIDE_LMRJ
                ],
                "result" => '',
                "description" => "OK CHECK PROCESS[" . __LINE__ . "] align",
            ],
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline4 align="light"',
                "params" => [
                    "align" => 'light',    // SIDE_LMRJ
                ],
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline4 title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline4 align="left"',
                "params" => [
                    "align" => 'left',    // SIDE_LMRJ
                ],
                "result" => '',
                "description" => "OK CHECK PROCESS[" . __LINE__ . "] align",
            ],
    ...
    public function provideValidateXhtml1Loose()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline4 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline4 title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => '',
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline4 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline4 align="justify"',
                "params" => [
                    "align" => 'justify',    // SIDE_LMRJ
                ],
                "result" => '',
                "description" => "OK CHECK PROCESS[" . __LINE__ . "] align",
            ],
    ...
    public function provideValidateXhtml1Frame()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#headline4 class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#headline4 align="lft"',
                "params" => [
                    "align" => 'lft',    // SIDE_LMRJ
                ],
                "result" => "[Validate Error] align : lft" . PHP_EOL,
                "description" => "NG CHECK PROCESS[" . __LINE__ . "] align",
            ],
