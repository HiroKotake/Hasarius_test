...
class TestCommandArticle extends HasariusTest
{
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#article style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#article title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
