...
class TestCommandHeadline2 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline2 class="サンプル テキスト"',
                "params" => [
                    "class" => 'サンプル テキスト',
                ],
                "result" => [],
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline2 title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => [],
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline2 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Loose()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline2 title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Strict()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_STRICT",
                "text" => '#headline2 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml11()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_1",
                "text" => '#headline2 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => [],
