...
class TestCommandHeadline1 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline1 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => [],
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline1 title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline1 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline1 align="midle"',
                "params" => [
                    "align" => 'midle',    // SIDE_LMRJ
                ],
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline1 title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Strict()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_STRICT",
                "text" => '#headline1 class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#headline1 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => [],
