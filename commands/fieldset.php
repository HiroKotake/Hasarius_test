...
class TestCommandFieldset extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#fieldset class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#fieldset lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#fieldset style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#fieldset form="sample text"',
                "params" => [
