...
class TestCommandHeadline5 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline5 class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline5 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline5 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline5 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline5 class="サンプル テキスト"',
                "params" => [
                    "class" => 'サンプル テキスト',
                ],
                "result" => '',
    ...
    public function provideValidateXhtml1Loose()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline5 title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateXhtml11()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_1",
                "text" => '#headline5 title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => '',
