...
class TestCommandHeadline3 extends HasariusTest
{
    ...
    public function provideValidateHtml4Loose()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_LOOSE",
                "text" => '#headline3 style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#headline3 class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateHtml4Frame()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_FRAME",
                "text" => '#headline3 lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Loose()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_LOOSE",
                "text" => '#headline3 class="サンプル テキスト"',
                "params" => [
                    "class" => 'サンプル テキスト',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Frame()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#headline3 style="サンプル テキスト"',
                "params" => [
                    "style" => 'サンプル テキスト',
                ],
                "result" => [],
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#headline3 title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => [],
