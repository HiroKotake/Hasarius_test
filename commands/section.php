...
class TestCommandSection extends HasariusTest
{
    ...
    public function provideValidateHtml5()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5",
                "text" => '#section style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5",
                "text" => '#section class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#section title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
