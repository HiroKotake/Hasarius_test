...
class TestCommandDatalist extends HasariusTest
{
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#datalist class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
