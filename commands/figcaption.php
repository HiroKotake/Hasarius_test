...
class TestCommandFigcaption extends HasariusTest
{
    ...
    public function provideValidateHtml5()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5",
                "text" => '#figcaption style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5",
                "text" => '#figcaption title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5",
                "text" => '#figcaption lang="sample text"',
                "params" => [
                    "lang" => 'sample text',
                ],
                "result" => '',
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#figcaption id="sample text"',
                "params" => [
                    "id" => 'sample text',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#figcaption title="サンプル テキスト"',
                "params" => [
                    "title" => 'サンプル テキスト',
                ],
                "result" => '',
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#figcaption lang="サンプル テキスト"',
                "params" => [
                    "lang" => 'サンプル テキスト',
                ],
                "result" => '',
