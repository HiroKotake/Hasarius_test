...
class TestCommandDefteam extends HasariusTest
{
    ...
    public function provideValidateHtml4Strict()
    {
        $params = [
            ...
            [
                "dtd" => "HTML4_STRICT",
                "text" => '#defteam title="sample text"',
                "params" => [
                    "title" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Strict()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_STRICT",
                "text" => '#defteam style="sample text"',
                "params" => [
                    "style" => 'sample text',
                ],
                "result" => [],
    ...
    public function provideValidateXhtml1Frame()
    {
        $params = [
            ...
            [
                "dtd" => "XHTML1_FRAME",
                "text" => '#defteam class="sample text"',
                "params" => [
                    "class" => 'sample text',
                ],
                "result" => [],
