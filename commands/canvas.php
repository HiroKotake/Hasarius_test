...
class TestCommandCanvas extends HasariusTest
{
    ...
    public function provideValidateHtml5()
    {
        $params = [
            ...
            [
                "dtd" => "HTML5",
                "text" => '#canvas height="-4086"',
                "params" => [
                    "height" => '-4086',    // US_NZ
                ],
                "result" => "[Validate Error] height : -4086" . PHP_EOL,
                "description" => "NG CHECK PROCESS[" . __LINE__ . "] height",
            ],
            // width OK Case
            [
                "dtd" => "HTML5",
                "text" => '#canvas width="20"',
                "params" => [
                    "width" => '20',    // US_NZ
                ],
                "result" => '',
            ...
            [
                ...
                "result" => "[Validate Error] width : -20" . PHP_EOL,
    ...
    public function provideValidateHtml51()
    {
        $params = [
            ...
            [
                ...
                "result" => "[Validate Error] height : -10" . PHP_EOL,
                "description" => "NG CHECK PROCESS[" . __LINE__ . "] height",
            ],
            // width OK Case
            [
            ...
            [
                "dtd" => "HTML5_1",
                "text" => '#canvas width="-256"',
                "params" => [
                    "width" => '-256',    // US_NZ
                ],
                "result" => "[Validate Error] width : -256" . PHP_EOL,
                "description" => "NG CHECK PROCESS[" . __LINE__ . "] width",
            ],
